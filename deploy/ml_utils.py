...
mdl_rf = jb.load("random_forest_20210103.pkl.z")
mdl_lgbm = jb.load("lgbm_20210103.pkl.z")
title_vec = jb.load("title_vectorizer_20210103.pkl.z")
...
#    like_count = data['like_count']
    ...
    num_features = csr_matrix(np.array([features['views'], features['views_por_dia'], features['like_count'], features['duration']]))
...
def compute_prediction(data):
    ...
    print("lista_de_features_para_predicao")
    print(feature_array)
